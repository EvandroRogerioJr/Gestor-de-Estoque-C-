...
namespace Projeto3
{
    class Program
    {
        ...
        {
            Console.WriteLine("Castrando Produto Fisico: ");
        ...
        {
            Console.WriteLine("Castrando Ebook: ");
            Console.WriteLine("Nome: ");
            string nome = Console.ReadLine();
            Console.WriteLine("Preço: ");
            float preco = float.Parse(Console.ReadLine());
        ...
        {
            Console.WriteLine("Castrando Curso: ");
            Console.WriteLine("Nome: ");
            string nome = Console.ReadLine();
            Console.WriteLine("Preço: ");
            float preco = float.Parse(Console.ReadLine());
